...
const ATM_DISPLAY_BUILD=Object.freeze({version:ATM_CONFIG?.build?.version||'v235.11.7',name:ATM_CONFIG?.build?.name||'Mobile Store Width Lock + Checkout UX'});
...
// ===== v235.11.7 Character Attribute Store + mobile width lock + dedicated checkout sheet =====
