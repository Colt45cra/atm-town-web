...
const ATM_DISPLAY_BUILD=Object.freeze({version:ATM_CONFIG?.build?.version||'v235.11.6',name:ATM_CONFIG?.build?.name||'Checkout UX Rebuild + Entry Stability'});
...
// ===== v235.11.6 Character Attribute Store + dedicated checkout sheet =====
