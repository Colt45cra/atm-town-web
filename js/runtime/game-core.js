...
const CHARACTER_SHEETS={classic:{src:'assets/characters/playable/atm.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33},fuzzy:{src:'assets/characters/playable/fuzzy.webp',preview:'assets/characters/thumbnails/character-fuzzy.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33},miracle:{src:'assets/characters/playable/miracle.webp',preview:'assets/characters/thumbnails/character-miracle.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33},luci:{src:'assets/characters/playable/luci.webp',preview:'assets/characters/thumbnails/character-luci.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33},triskeleton:{src:'assets/characters/playable/triskeleton.webp',preview:'assets/characters/thumbnails/character-triskeleton.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33},phnix:{src:'assets/characters/playable/phnix.webp',preview:'assets/characters/thumbnails/character-phnix.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33},bear:{src:'assets/characters/playable/bear.webp',preview:'assets/characters/thumbnails/character-bear.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33},xoge:{src:'assets/characters/playable/xoge.webp',preview:'assets/characters/thumbnails/character-xoge.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33},flippy:{src:'assets/characters/playable/flippy.webp',preview:'assets/characters/thumbnails/character-flippy.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33},salute:{src:'assets/characters/playable/salute.webp',preview:'assets/characters/thumbnails/character-salute.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33},brad:{src:'assets/characters/playable/brad.webp',preview:'assets/characters/thumbnails/character-brad.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33},david:{src:'assets/characters/playable/david.webp',preview:'assets/characters/thumbnails/character-david.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33},kaj:{src:'assets/characters/playable/kaj.webp',preview:'assets/characters/thumbnails/character-kaj.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33},victoria:{src:'assets/characters/playable/victoria.webp',cols:3,rows:4,rowOrder:['down','left','up','right'],anchorX:128,anchorY:303,displayScale:.33}};
...
const ALLOWED_CHARACTERS=['classic','fuzzy','miracle','luci','triskeleton','phnix','bear','xoge','flippy','salute','brad','david','kaj'];
...
function lockerVisibleItems(forInventory=false){
  if(forInventory)return ATM_ITEM_CATALOG.slice();
...
function lockerRenderGrids(){
  ...
  const inventoryGrid=document.getElementById('lockerInventoryGrid');if(inventoryGrid){inventoryGrid.textContent='';for(const item of lockerVisibleItems(true))inventoryGrid.appendChild(lockerCreateItemCard(item));}
}
