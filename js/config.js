 ...
 * v235.12.5: fixes the remote-player Prop Hunt startup ReferenceError and makes every found prop become a seeker; the final prop actually found wins.
...
(function initializeATMTownConfig(global) {
  ...
  const BUILD = Object.freeze({
    number: 235.122,
    version: 'v235.12.5',
    name: 'Prop Hunt Seeker Hotfix',
    title: 'ATM Town v235.12.5 — Prop Hunt Seeker Hotfix'
  });
