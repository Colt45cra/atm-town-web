...
if (!atmGuideSource.includes('/Android/i.test') || !atmGuideSource.includes("global.open(CLAIM_PORTAL_URL,'_blank')") || !atmGuideSource.includes('global.location.assign(CLAIM_PORTAL_URL)')) errors.push('ATM Bot is missing its Android direct-open claim fallback.');
...
if (!serviceWorkerSource.includes("atm-town-shell-v235.12.13") || !serviceWorkerSource.includes('/js/zombie-outbreak.js') || !serviceWorkerSource.includes('/js/prop-hunt.js') || !serviceWorkerSource.includes('/assets/maps/town/foreground/day/assets_05_00.webp') || !serviceWorkerSource.includes('/assets/maps/town/foreground/day/assets_18_00.webp') || !serviceWorkerSource.includes('/js/runtime/neon-racer.js') || !serviceWorkerSource.includes('/js/live-chat.js') || !serviceWorkerSource.includes('/js/atm-ecosystem-guide.js')) errors.push('v235.12.13 PWA shell cache/module registration is missing.');
