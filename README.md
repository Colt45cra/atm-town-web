...
**v235.11.4 — Entry Session Stability + Mobile Store**
...
Apply the v235.11.4 change files to the repository root, preserving all folders and paths. Do not flatten `/assets`, `/api`, `/js`, `/docs`, or `/scripts`.
